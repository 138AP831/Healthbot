...
- [Setup / how to reproduce](#setup--how-to-reproduce)
...
| Automation | Zaps (Zap button trigger → Sheets / Calendar / Slack actions) |
...
1. Create a free [Zapier Chatbots](https://zapier.com/app/chatbots) account.
...
6. Test using the chatbot's **public share link** (not the in-builder preview — button-click triggers don't register from the preview pane).
...
```markdown
### Logic flow
![Logic tab](screenshots/logic-tab.png)

### Live conversation
![Chat preview](screenshots/chat-preview.png)

### Connected Zap
![Zap editor](screenshots/zap-editor.png)
```
...
````
Live Link: https://rivahealthbot.zapier.app/
